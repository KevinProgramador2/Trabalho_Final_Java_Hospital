...
-- inserindo o registro de clientes (pode ser tanto plano de saúde quanto paciente)

INSERT INTO cliente(nome, paciente_id, planoSaude_id) VALUES
('Eduardo Ferreira', 1, NULL),
('Fernanda Gomes', 2, NULL),
('Gabriel Souza', 3, NULL),
('Helena Ipanema', 4, NULL),
('Igor Justino', 5, NULL),
('Julia Kastro', 6, NULL),
('Arnaldo Antunes', 7, NULL),
('Beatriz Cavalcante', 8, NULL),
('Claudio Castro', 9, NULL),
('Daniela Escobar', 10, NULL);
